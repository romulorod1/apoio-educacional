# Catálogo de temas de matemática

Do 2º ano do ensino fundamental ao 3º ano do ensino médio. Cada tema tem material explicativo,
lista de exercícios e gabarito, em português e em inglês.

**Legenda de situação:** `pronto` passou pela verificação automática. `previsto` está catalogado e
...
|---|---|---|---|
| MAT02-01 | Números até 100: ler, escrever e comparar | numeros | pronto |
| MAT02-02 | Adição até 100 | numeros | pronto |
| MAT02-03 | Subtração até 100 | numeros | pronto |
| MAT02-04 | Dobro, metade e triplo | numeros | pronto |
| MAT02-05 | Sequências e padrões numéricos | algebra | pronto |
| MAT02-06 | Figuras planas: reconhecer e nomear | geometria | pronto |
| MAT02-07 | Sólidos geométricos no dia a dia | geometria | pronto |
| MAT02-08 | Medindo comprimentos | grandezas | pronto |
| MAT02-09 | Horas, dias e meses | grandezas | pronto |
| MAT02-10 | Dinheiro: moedas e cédulas | grandezas | pronto |
| MAT02-11 | Tabelas e gráficos simples | estatistica | pronto |
| MAT02-12 | Problemas do dia a dia | numeros | pronto |

## 3º ano do fundamental

| ID | Tema | Unidade | Situação |
|---|---|---|---|
| MAT03-01 | Números até 1000 e valor posicional | numeros | pronto |
| MAT03-02 | Adição com reagrupamento | numeros | pronto |
| MAT03-03 | Subtração com reagrupamento | numeros | pronto |
| MAT03-04 | Multiplicação: a ideia e a tabuada | numeros | pronto |
| MAT03-05 | Divisão: repartir em partes iguais | numeros | pronto |
| MAT03-06 | Metade, terço e quarto | numeros | pronto |
| MAT03-07 | Figuras planas e seus lados | geometria | pronto |
| MAT03-08 | Metro e centímetro | grandezas | pronto |
| MAT03-09 | Massa e capacidade | grandezas | pronto |
| MAT03-10 | Dinheiro e troco | grandezas | pronto |
| MAT03-11 | Relógio e calendário | grandezas | pronto |
| MAT03-12 | Gráficos de barras | estatistica | pronto |

## 4º ano do fundamental

| ID | Tema | Unidade | Situação |
|---|---|---|---|
| MAT04-01 | Números até 10.000 e valor posicional | numeros | pronto |
| MAT04-02 | Adição e subtração com números grandes | numeros | pronto |
| MAT04-03 | Multiplicação por dois algarismos | numeros | pronto |
| MAT04-04 | Divisão com resto | numeros | pronto |
| MAT04-05 | Frações: comparar e encontrar equivalentes | numeros | pronto |
| MAT04-06 | Números decimais com dinheiro e medidas | numeros | pronto |
| MAT04-07 | Retas, ângulos e giros | geometria | pronto |
| MAT04-08 | Polígonos e simetria | geometria | pronto |
| MAT04-09 | Perímetro e área | grandezas | pronto |
| MAT04-10 | Unidades de medida e transformações | grandezas | pronto |
| MAT04-11 | Possível, impossível e provável | estatistica | pronto |
| MAT04-12 | Gráficos e média simples | estatistica | pronto |

## 5º ano do fundamental

| ID | Tema | Unidade | Situação |
|---|---|---|---|
| MAT05-01 | Números até 100.000 e o sistema decimal | numeros | pronto |
| MAT05-02 | As quatro operações com naturais | numeros | pronto |
| MAT05-03 | Frações com o mesmo denominador | numeros | pronto |
| MAT05-04 | Frações e decimais: a mesma ideia | numeros | pronto |
| MAT05-05 | Operações com decimais | numeros | pronto |
| MAT05-06 | Porcentagem: primeiros passos | numeros | pronto |
| MAT05-07 | Múltiplos e divisores | numeros | pronto |
| MAT05-08 | Sólidos e suas planificações | geometria | pronto |
| MAT05-09 | Perímetro, área e volume | grandezas | pronto |
| MAT05-10 | Transformando unidades de medida | grandezas | pronto |
| MAT05-11 | Localização e plano cartesiano | geometria | pronto |
| MAT05-12 | Média, tabelas e gráficos | estatistica | pronto |

## 6º ano do fundamental

| ID | Tema | Unidade | Situação |
|---|---|---|---|
| MAT06-01 | Sistema de numeração decimal | numeros | pronto |
| MAT06-02 | Operações com números naturais | numeros | pronto |
| MAT06-03 | Múltiplos, divisores, MMC e MDC | numeros | pronto |
| MAT06-04 | Números primos e fatoração | numeros | pronto |
| MAT06-05 | Frações: o que são e como comparar | numeros | pronto |
| MAT06-06 | Operações com frações | numeros | pronto |
| MAT06-07 | Números decimais e suas operações | numeros | pronto |
| MAT06-08 | Porcentagem no dia a dia | numeros | pronto |
| MAT06-09 | Ângulos e retas | geometria | pronto |
| MAT06-10 | Polígonos e sua classificação | geometria | pronto |
| MAT06-11 | Perímetro e área de figuras planas | grandezas | pronto |
| MAT06-12 | Volume e unidades de medida | grandezas | pronto |
| MAT06-13 | Plano cartesiano | geometria | pronto |
| MAT06-14 | Tabelas, gráficos e média | estatistica | pronto |
...
| ID | Tema | Unidade | Situação |
|---|---|---|---|
| MATEM1-01 | Conjuntos numéricos | numeros | pronto |
| MATEM1-02 | Função: domínio, contradomínio e imagem | algebra | pronto |
| MATEM1-03 | Função afim | algebra | pronto |
| MATEM1-04 | Função quadrática | algebra | pronto |
