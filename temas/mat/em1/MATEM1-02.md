...
**Exemplo 1.** Seja f com domínio formado por 1, 2 e 3, dada por f(x) = 2x + 1.
Aplicando a regra em cada entrada: f(1) = 3, f(2) = 5 e f(3) = 7. Logo a imagem é formada por 3, 5 e
7. Se alguém tivesse declarado o contradomínio como o conjunto dos naturais, a imagem continuaria
sendo apenas esses três valores.
...
**Exemplo 2.** Achar o domínio de f(x) = 1/(x - 3).
O denominador zera quando x = 3, então o domínio é o conjunto de todos os reais menos o número 3.

**Exemplo 3.** Achar o domínio de f(x) = √(x - 4).
Precisa valer x - 4 ≥ 0, ou seja, x ≥ 4. O domínio são os reais maiores ou iguais a 4.
...
**Exemplo 4.** Achar a imagem de f(x) = x^{2} - 4x + 3.
O x do vértice é 4/2 = 2, e f(2) = 4 - 8 + 3 = -1. Como a concavidade é para cima, a imagem são os
...
de y a equação f(x) = y tem solução? Os y que têm solução formam a imagem.
...
**Trocar f(x) = 5 por f(5).** A primeira pergunta procura a entrada que produz saída 5. A segunda
calcula a saída quando a entrada é 5. São perguntas opostas.

### Exercícios

**Bloco A. Fundamentos**

1. Seja f a função de domínio formado pelos elementos 1, 2 e 3, dada por f(x) = 2x + 1. Determine
   o conjunto imagem.
2. Dada f(x) = 3x - 5, calcule f(0), f(2) e f(-1).
3. Determine o domínio de f(x) = 1/(x - 3).
4. Determine o domínio de f(x) = √(x - 4).
5. Dada f(x) = x^{2}, calcule f(-3) e diga se existe algum número real x com f(x) = -9.

**Bloco B. Consolidação**

6. Determine o domínio de f(x) = (x + 1)/(x^{2} - 4).
7. Determine o domínio de f(x) = √(2x - 6)/(x - 5).
8. Dada f(x) = 2x - 7, determine o valor de x para o qual f(x) = 9.
9. Determine o conjunto imagem de f(x) = x^{2} - 4x + 3, com domínio em todos os reais.
10. Uma função tem domínio formado por 1, 2, 3 e 4, contradomínio formado por 1, 4, 9, 16 e 25, e
    lei f(x) = x^{2}. Determine a imagem e diga se a função é sobrejetora.
11. Dada f(x) = (3x + 1)/2, determine o valor de x para o qual f(x) = 5 e calcule f(3).
12. Determine o domínio de f(x) = √(9 - x^{2}).
...
14. Determine o domínio de f(x) = √(x - 2) + √(5 - x).
15. Uma função é definida por partes: ela vale 2x + 1 quando x < 1, e vale x^{2} quando x ≥ 1.
    Calcule f(0), f(1) e f(3), e diga se há salto no ponto de abscissa 1.
16. Determine o conjunto imagem de f(x) = 1/(x - 2), tomando como domínio todos os reais diferentes
    de 2.
17. Considere f(x) = (2x + 3)/(x - 1), definida para x ≠ 1. Determine o valor que f nunca assume e
    justifique isolando x.
...
2. f(0) = -5, f(2) = 1 e f(-1) = -8.
3. Todos os números reais, exceto 3.
4. Os reais maiores ou iguais a 4.
5. f(-3) = 9. Não existe, porque o quadrado de um real nunca é negativo.
6. Todos os reais, exceto -2 e 2.
7. Os reais maiores ou iguais a 3, tirando o 5.
8. x = 8.
9. Os reais maiores ou iguais a -1, porque o vértice fica no ponto (2, -1).
10. A imagem é formada por 1, 4, 9 e 16. Não é sobrejetora, porque o 25 não é imagem de nenhum
    elemento do domínio.
11. x = 3, e f(3) = 5.
12. Os valores de -3 a 3, incluindo os extremos.
13. A lei é f(d) = 40 + 3d. A imagem vai de 40 a 340 reais, com os extremos incluídos.
14. Os valores de 2 a 5, incluindo os extremos, porque as duas condições precisam valer ao mesmo
    tempo.
15. f(0) = 1, f(1) = 1 e f(3) = 9. Há salto: vindo de valores menores que 1 a função se aproxima de
    3, mas em 1 ela vale 1.
...
**Example 1.** Let f have domain made of 1, 2 and 3, given by f(x) = 2x + 1.
Applying the rule to each input: f(1) = 3, f(2) = 5 and f(3) = 7. So the image is made of 3, 5 and
...
**Example 2.** Find the domain of f(x) = 1/(x - 3).
The denominator vanishes when x = 3, so the domain is the set of all reals minus the number 3.

**Example 3.** Find the domain of f(x) = √(x - 4).
We need x - 4 ≥ 0, that is, x ≥ 4. The domain is the reals greater than or equal to 4.
...
**Example 4.** Find the image of f(x) = x^{2} - 4x + 3.
The x of the vertex is 4/2 = 2, and f(2) = 4 - 8 + 3 = -1. Since the parabola opens upwards, the
image is the reals greater than or equal to -1.

Another route, useful for stranger expressions, is to turn the question round: for which values of y
does the equation f(x) = y have a solution? The values of y that do have one form the image.
...
**Swapping f(x) = 5 for f(5).** The first question looks for the input that produces output 5. The
second works out the output when the input is 5. They are opposite questions.

### Exercises

**Block A. Fundamentals**

1. Let f be the function whose domain is made of the elements 1, 2 and 3, given by f(x) = 2x + 1.
   Find the image set.
2. Given f(x) = 3x - 5, find f(0), f(2) and f(-1).
3. Find the domain of f(x) = 1/(x - 3).
4. Find the domain of f(x) = √(x - 4).
5. Given f(x) = x^{2}, find f(-3) and say whether there is any real number x with f(x) = -9.

**Block B. Building up**

6. Find the domain of f(x) = (x + 1)/(x^{2} - 4).
7. Find the domain of f(x) = √(2x - 6)/(x - 5).
8. Given f(x) = 2x - 7, find the value of x for which f(x) = 9.
9. Find the image set of f(x) = x^{2} - 4x + 3, with domain all the reals.
10. A function has domain made of 1, 2, 3 and 4, codomain made of 1, 4, 9, 16 and 25, and rule
    f(x) = x^{2}. Find the image and say whether the function is surjective.
11. Given f(x) = (3x + 1)/2, find the value of x for which f(x) = 5 and work out f(3).
12. Find the domain of f(x) = √(9 - x^{2}).
...
14. Find the domain of f(x) = √(x - 2) + √(5 - x).
15. A function is defined piecewise: it equals 2x + 1 when x < 1, and equals x^{2} when x ≥ 1. Find
    f(0), f(1) and f(3), and say whether there is a jump at the point of abscissa 1.
16. Find the image set of f(x) = 1/(x - 2), taking as domain all the reals different from 2.
17. Consider f(x) = (2x + 3)/(x - 1), defined for x ≠ 1. Find the value that f never takes and
    justify it by isolating x.
...
2. f(0) = -5, f(2) = 1 and f(-1) = -8.
3. All real numbers except 3.
4. The reals greater than or equal to 4.
5. f(-3) = 9. There is none, because the square of a real is never negative.
6. All the reals except -2 and 2.
7. The reals greater than or equal to 3, leaving out 5.
8. x = 8.
9. The reals greater than or equal to -1, because the vertex sits at the point (2, -1).
10. The image is made of 1, 4, 9 and 16. It is not surjective, because 25 is not the image of any
    element of the domain.
11. x = 3, and f(3) = 5.
12. The values from -3 to 3, including the endpoints.
13. The rule is f(d) = 40 + 3d. The image runs from 40 to 340 reais, with the endpoints included.
14. The values from 2 to 5, including the endpoints, because both conditions have to hold at the
    same time.
15. f(0) = 1, f(1) = 1 and f(3) = 9. There is a jump: coming from values less than 1 the function
