 ...
 *   item 3 com a caixa do rótulo estreita (10 pt): o número também sai acima;
  ...
  for (const m of MODULOS) {
    ...
    m.listas.forEach((l, li) => {
      ...
      for (let n = 1; n <= l.itens; n++) {
        ...
        // o 3 tem a caixa do rótulo estreita: o número não cabe com 7 pt e vai para a faixa de cima
        const rotulo = deCompor ? (n === 2 ? null : n === 3 ? [4, 4, 14, 16] : [4, 4, 60, 16]) : undefined;
