...
const ALVOS = [
  ['depois-compositor',        '#m-compositor'],
  ['depois-aula-ordem',        '#m-aula-ordem'],
  ['depois-consolidado-dela',  '#m-consolidado-dela'],
  ['depois-consolidado-pais',  '#m-consolidado-pais']
];
(async () => {
  ...
  await pag.goto('http://127.0.0.1:8777/_teste/prints/_maquetes2.html', { waitUntil: 'networkidle0' });
