...
# Lote 2 da varredura (frente 3), 08/09/2026: os quatro temas de geometria que
# faltavam ao alcance do kit. Com o lote 1 eles fecham a geometria que o kit de
# hoje cobre. Rodam sem argumento, contra o temas/banco.json.
roda "piloto MAT09-07"  node figuras/_piloto_MAT09-07.js
roda "piloto MATEM2-03" node figuras/_piloto_MATEM2-03.js
roda "piloto MATEM2-11" node figuras/_piloto_MATEM2-11.js
roda "piloto MATEM2-12" node figuras/_piloto_MATEM2-12.js
...
roda "biblioteca aula --envenenado-acento"     node "_teste/testa_biblioteca_aula.js" --envenenado-acento
# FRENTE B: a dificuldade na lista (rotulo estimada/revisada, filtro Facil, Medio,
...
# soltos". O veneno religa a chave no app.js servido, e o teste tem que ver o
# botao voltar: sem ele, as asercoes de ausencia passariam por qualquer motivo.
...
# e "Marcar os N deste modulo" na navegacao livre. Cada veneno desliga UMA regra:
# o carrinho que nao enche, a lista que mente depois da tela cheia, e o botao do
# modulo que nunca vira "Desmarcar".
