...
salvar('Matematica/Algebra/Questoes_Funcoes_e_Equacoes.json', {
  ...
  benchmark_didatico: {
    ...
    resumo_teorico: {
      conceitos_chave: [
        ...
        "Função Afim: f(x) = ax + b (com a, b reais e a != 0). O coeficiente angular a = \Δ y / \Δ x representa a taxa de crescimento constante. O coeficiente linear b é o ponto (0, b) onde a reta corta o eixo y. A raiz é x = -b/a. Crescente se a > 0; decrescente se a < 0.",
        "Função Quadrática: f(x) = ax^2 + bx + c (a != 0). O gráfico é uma parábola com concavidade voltada para cima se a > 0 e para baixo se a < 0. As raízes reais são obtidas por Bhaskara: x = (-b \± \√(\Δ))/(2a), com \Δ = b^2 - 4ac. Se \Δ > 0, duas raízes distintas; se \Δ = 0, raiz dupla real; se \Δ < 0, sem raízes reais.",
        "Coordenadas do Vértice e Otimização: O ponto de extremo (máximo se a < 0, mínimo se a > 0) possui coordenadas x_v = -b/(2a) e y_v = -\Δ/(4a). A reta vertical x = x_v é o eixo de simetria da parábola.",
    ...
    exemplo_resolvido: {
      ...
      resolucao_passo_a_passo: [
        ...
        "4. Função Receita Bruta: R(x) = P(x) \· N(x) = (200 - 10x)(60 + 5x) = 12000 + 1000x - 600x - 50x^2 = -50x^2 + 400x + 12000.",
        "5. Ponto de máximo da receita: Como a = -50 < 0, a parábola atinge o ápice no vértice: x_v = -b/(2a) = -400 / [2 \· (-50)] = -400 / -100 = 4 reduções.",
        "6. Preço ótimo: P(4) = 200 - 10(4) = R$ 160,00 por aluno.",
        "7. Alunos matriculados no ponto ótimo: N(4) = 60 + 5(4) = 80 alunos.",
        "8. Receita máxima: R(4) = 160 \· 80 = R$ 12.800,00.",
  ...
  questoes: [
    ...
    },
    {
      ...
      gabarito: {
        letra: "a",
        ancora: "x_v = -(-6)/(2 \· 1) = 3; y_v = 3^2 - 6(3) + 5 = 9 - 18 + 5 = -4. V = (3, -4).",
    ...
    },
    {
      ...
      gabarito: {
        letra: "b",
        ancora: "243 = 3^5. 3^{2x - 1} = 3^5 \⇒ 2x - 1 = 5 \⇒ 2x = 6 \⇒ x = 3.",
    ...
    },
    {
      ...
      tipo: "fechada",
      enunciado: "O valor da expressão numérico-logarítmica E = log_{2}(64) + log_{3}(81) - log_{5}(125) é igual a:",
      imagem_descricao: null,
      alternativas: [
        { letra: "a", texto: "5" },
        { letra: "b", texto: "7" },
      ...
      gabarito: {
        letra: "b",
        ancora: "log_{2}(64) = 6 (pois 2^6 = 64); log_{3}(81) = 4 (pois 3^4 = 81); log_{5}(125) = 3 (pois 5^3 = 125). E = 6 + 4 - 3 = 7.",
    ...
    },
    {
      ...
      tipo: "fechada",
      enunciado: "Sabendo que log_{10}(2) \≈ 0,30 e log_{10}(3) \≈ 0,48, o valor aproximado de log_{10}(18) é:",
      imagem_descricao: null,
      alternativas: [
        { letra: "a", texto: "1,14" },
        { letra: "b", texto: "1,26" },
      ...
      gabarito: {
        letra: "b",
        ancora: "18 = 2 \· 3^2. log(18) = log(2) + 2log(3) \≈ 0,30 + 2(0,48) = 0,30 + 0,96 = 1,26.",
    ...
    // BLOCO 2: CONSOLIDAÇÃO (6 a 10)
    {
      ...
      gabarito: {
        letra: "d",
        ancora: "C(h) = 45 + 32h = 205 \⇒ 32h = 160 \⇒ h = 5 horas.",
    ...
    },
    {
      ...
      gabarito: {
        letra: "c",
        ancora: "t_v = -8 / (2 \· (-1)) = 4 s. h_v = -(4)^2 + 8(4) + 20 = -16 + 32 + 20 = 36 m.",
    ...
    },
    {
      ...
      imagem_descricao: null,
      alternativas: [
        { letra: "a", texto: "P(t) = 500 \· 3^{4t}" },
        { letra: "b", texto: "P(t) = 500 \· 3^{t/4}" },
        { letra: "c", texto: "P(t) = 500 \· 4^{3t}" },
      ...
      gabarito: {
        letra: "b",
        ancora: "P(0) = 500; P(4) = 500 \· 3^1; P(8) = 500 \· 3^2. Logo P(t) = 500 \· 3^{t/4}.",
    ...
    },
    {
      ...
      tipo: "fechada",
      enunciado: "Se log_{2}(x) = k, o valor de log_{8}(x^3) expresso em termos de k é:",
      imagem_descricao: null,
      alternativas: [
        { letra: "a", texto: "k/3" },
        { letra: "b", texto: "k" },
      ...
      gabarito: {
        letra: "b",
        ancora: "log_{8}(x^3) = log_{2^3}(x^3) = \3 / 3 log_{2}(x) = log_{2}(x) = k.",
    ...
    // BLOCO 3: APROFUNDAMENTO & EXCELÊNCIA (11 a 15)
    {
      ...
      tipo: "aberta",
      enunciado: "Resolva a equação logarítmica no conjunto dos números reais:\nlog_{2}(x + 6) + log_{2}(x - 1) = 3.\nApresente a condição de existência e justifique a exclusão de eventuais raízes espúrias.",
      imagem_descricao: null,
      resposta: "C.E.: x > 1; Solução: S = {2}",
      gabarito: {
        espera_se: "Determinar C.E.: x + 6 > 0 (x > -6) e x - 1 > 0 (x > 1) -> intersecção x > 1. Aplicando propriedade do produto: log_{2}[(x+6)(x-1)] = 3 -> x^2 + 5x - 6 = 2^3 = 8 -> x^2 + 5x - 14 = 0. Raízes por Bhaskara: x = 2 e x = -7. Como x = -7 < 1 não atende à C.E., descarta-se. Conjunto solução: S = {2}.",
        aceita_se: ["x = 2", "S = {2}"],
    ...
    },
    {
      ...
      tipo: "fechada",
      enunciado: "A soma de todos os números inteiros pertencentes ao conjunto solução da inequação exponencial 9^x - 10 \· 3^x + 9 <= 0 é:",
      imagem_descricao: null,
      alternativas: [
        { letra: "a", texto: "1" },
        { letra: "b", texto: "2" },
    ...
    },
    {
      ...
      tipo: "fechada",
      enunciado: "O número de soluções reais distintas da equação x^{log_{2}(x)} = 64x é igual a:",
      imagem_descricao: null,
      alternativas: [
        { letra: "a", texto: "0" },
        { letra: "b", texto: "1" },
      ...
      gabarito: {
        letra: "c",
        ancora: "C.E.: x > 0. Aplicando log_{2} em ambos os lados: log_{2}(x^{log_{2}(x)}) = log_{2}(64x) -> [log_{2}(x)]^2 = log_{2}(64) + log_{2}(x) -> y^2 - y - 6 = 0, com y = log_{2}(x). Raízes: y = 3 ou y = -2. Para y = 3: x = 2^3 = 8. Para y = -2: x = 2^{-2} = 1/4. Ambas são válidas, logo há 2 soluções.",
    ...
    },
    {
      ...
      gabarito: {
        letra: "b",
        ancora: "Seja u = log_{b}(a). Como log_{a}(b) = 1/u, temos u + 1/u = 17/4 -> 4u^2 - 17u + 4 = 0. Raízes: u = 4 ou u = 1/4. Como a > b > 1, log_{b}(a) = u = 4 -> a = b^4. Substituindo em a \· b = 32: b^4 \· b = b^5 = 32 -> b = 2. Logo a = 2^4 = 16. A razão a / b = 16 / 2 = 8.",
...
salvar('Matematica/Geometria/Questoes_Geometria_Plana_e_Espacial.json', {
  ...
  benchmark_didatico: {
    ...
    resumo_teorico: {
      conceitos_chave: [
        "Relações Métricas no Triângulo Retângulo: a^2 = b^2 + c^2 (Teorema de Pitágoras); b^2 = a \· m; c^2 = a \· n; h^2 = m \· n; a \· h = b \· c, onde a é a hipotenusa, b e c são catetos, h é a altura relativa e m, n são as projeções dos catetos sobre a hipotenusa.",
        "Áreas de Triângulos: Fórmula fundamental A = (b \· h)/2; Fórmula trigonométrica: A = \1 / 2 a b \sen(\θ); Fórmula de Heron: A = \√(p(p-a)(p-b)(p-c)), sendo p o semiperímetro; Em função do raio inscrito: A = p \· r; Em função do raio circunscrito: A = \abc / 4R.",
        "Prismas e Cilindros: Sólidos retos ou oblíquos com bases paralelas e congruentes. Volume = Área da Base \× Altura (V = A_b \· h). Área lateral do cilindro reto: A_l = 2\π r h. Cilindro equilátero possui h = 2r e seção meridiana quadrada.",
        "Pirâmides e Cones: Sólidos pontiagudos com convergência no vértice. Volume = \1 / 3 A_b \· h. Relação fundamental no cone circular reto: g^2 = h^2 + r^2 (onde g é a geratriz). Área lateral do cone: A_l = \π r g.",
        "Esfera: Área da superfície esférica S = 4\π r^2. Volume da esfera V = \4 / 3\π r^3. Fuso esférico (área) e cunha esférica (volume) são proporcionais ao ângulo diedro correspondente.",
    ...
    exemplo_resolvido: {
      ...
      resolucao_passo_a_passo: [
        ...
        "3. Raio da superfície da água: r = k \· R = (1/2) \· 4 = 2 metros.",
        "4. Volume total do reservatório: V_{total} = (1/3) \π R^2 H = (1/3) \π (4)^2 (6) = 32\π m^3.",
        "5. Volume de água: V_{água} = (1/3) \π r^2 h = (1/3) \π (2)^2 (3) = 4\π m^3.",
        ...
        "8. Volume em metros cúbicos: V_{água} = 4 \× 3,14 = 12,56 m^3 (ou 12.560 litros)."
      ]
    }
  },
  questoes: [
    // BLOCO 1: FUNDAMENTOS (1 a 5)
    {
      ...
      gabarito: {
        letra: "b",
        ancora: "d^2 = 40^2 + 30^2 = 1600 + 900 = 2500 \⇒ d = 50 m",
    ...
    },
    {
      ...
      tipo: "fechada",
      enunciado: "Uma mesa redonda de jantar possui raio de 0,80 metros. Adotando \π = 3,14, a área da toalha circular que cobre exatamente o tampo dessa mesa é de:",
      imagem_descricao: null,
      alternativas: [
      ...
      gabarito: {
        letra: "b",
        ancora: "A = \π r^2 = 3,14 \· (0,80)^2 = 3,14 \· 0,64 = 2,0096 m².",
    ...
    },
    {
      ...
      gabarito: {
        letra: "c",
        ancora: "V = 2 \· 1,5 \· 1 = 3 m^3. Como 1 m^3 = 1.000 L, V = 3.000 L.",
    ...
    },
    {
      ...
      tipo: "fechada",
      enunciado: "Um cilindro circular reto possui raio da base medindo 3 cm e altura medindo 10 cm. Adotando \π = 3,14, o volume desse cilindro é:",
      imagem_descricao: null,
      alternativas: [
      ...
      gabarito: {
        letra: "c",
        ancora: "V = \π r^2 h = 3,14 \· 3^2 \· 10 = 3,14 \· 9 \· 10 = 282,6 cm³.",
    ...
    },
    {
      ...
      tipo: "fechada",
      enunciado: "Uma esfera metálica maciça tem raio igual a 3 cm. O volume dessa esfera, em função de \π, é:",
      imagem_descricao: null,
      alternativas: [
        { letra: "a", texto: "12\π cm³" },
        { letra: "b", texto: "24\π cm³" },
        { letra: "c", texto: "36\π cm³" },
        { letra: "d", texto: "48\π cm³" },
        { letra: "e", texto: "108\π cm³" }
      ],
      resposta: "c",
      gabarito: {
        letra: "c",
        ancora: "V = (4/3) \π r^3 = (4/3) \π (3)^3 = (4/3) \π (27) = 36\π cm³.",
    ...
    // BLOCO 2: CONSOLIDAÇÃO (6 a 10)
    {
      ...
      gabarito: {
        letra: "c",
        ancora: "V_A = \π r^2 h; V_B = \π (2r)^2 (h/2) = \π (4r^2) (h/2) = 2\π r^2 h. Logo, V_B / V_A = 2.",
    ...
    },
    {
      ...
      tipo: "fechada",
      enunciado: "Em uma praça circular no bairro de São Francisco, em Niterói, com raio medindo 12 metros, será construído um canteiro com o formato de um setor circular cujo ângulo central mede 60°. Adotando \π = 3,14, a área desse canteiro é de:",
      ...
      gabarito: {
        letra: "b",
        ancora: "A_{setor} = (60/360) \· \π r^2 = (1/6) \· 3,14 \· (12)^2 = (1/6) \· 3,14 \· 144 = 24 \· 3,14 = 75,36 m²",
    ...
    },
    {
      ...
      tipo: "fechada",
      enunciado: "Uma embalagem tem a forma de um tronco de cone circular reto cujos raios das bases medem 6 cm e 3 cm, e a altura mede 4 cm. O volume dessa embalagem em função de \π é:",
      imagem_descricao: null,
      alternativas: [
        { letra: "a", texto: "52\π cm³" },
        { letra: "b", texto: "64\π cm³" },
        { letra: "c", texto: "76\π cm³" },
        { letra: "d", texto: "84\π cm³" },
        { letra: "e", texto: "108\π cm³" }
      ],
      resposta: "c",
      gabarito: {
        letra: "c",
        ancora: "V = (\π h / 3) (R^2 + Rr + r^2) = (4\π / 3) (6^2 + 6 \· 3 + 3^2) = (4\π / 3) (36 + 18 + 9) = (4\π / 3) \· 63 = 4\π \· 21 = 84\π cm³? Não: 4 * 21 = 84pi. Mas se R=6, r=3: 36+18+9 = 63. 63/3 = 21. 21 * 4 = 84. Letra d = 84pi.",
    ...
    },
    {
      ...
      gabarito: {
        letra: "c",
        ancora: "h^2 = m \· n \⇒ 12^2 = 9 \· n \⇒ 144 = 9n \⇒ n = 16 cm. Hipotenusa a = m + n = 9 + 16 = 25 cm.",
    ...
    },
    {
      ...
      imagem_descricao: null,
      alternativas: [
        { letra: "a", texto: "300\√(3) cm²" },
        { letra: "b", texto: "600\√(3) cm²" },
        { letra: "c", texto: "900\√(3) cm²" },
        { letra: "d", texto: "1200\√(3) cm²" },
        { letra: "e", texto: "2400\√(3) cm²" }
      ],
      resposta: "b",
      gabarito: {
        letra: "b",
        ancora: "A = 6 \· \(l^2 \√(3)) / (4) = 6 \· \(400 \√(3)) / (4) = 6 \· 100\√(3) = 600\√(3) cm².",
    ...
    // BLOCO 3: APROFUNDAMENTO & EXCELÊNCIA (11 a 15)
    {
      ...
      gabarito: {
        letra: "b",
        ancora: "m = l/2 = 6 cm; g^2 = h^2 + m^2 = 8^2 + 6^2 = 100 \⇒ g = 10 cm. A_{base} = 12^2 = 144 cm². A_{lateral} = 4 \· (12 \· 10 / 2) = 240 cm². A_{total} = 144 + 240 = 384 cm².",
    ...
    },
    {
      ...
      gabarito: {
        espera_se: "Calcular semiperímetro p = (13 + 14 + 15)/2 = 42/2 = 21 cm. Pela fórmula de Heron: A = \√(21(21-13)(21-14)(21-15)) = \√(21 \· 8 \· 7 \· 6) = \√(3 \· 7 \· 8 \· 7 \· 2 \· 3) = \√(3^2 \· 7^2 \· 16) = 3 \· 7 \· 4 = 84 cm². O raio inscrito satisfaz A = p \· r -> 84 = 21 \· r -> r = 4 cm.",
        aceita_se: ["A = 84 cm² e r = 4 cm"],
        ancora: "p = 21 cm. A = \√(21 \· 8 \· 7 \· 6) = 84 cm². r = A / p = 84 / 21 = 4 cm."
      }
    },
    {
      id: "MAT-GEO-013",
      ...
      alternativas: [
        { letra: "a", texto: "48\π cm³" },
        { letra: "b", texto: "72\π cm³" },
        { letra: "c", texto: "96\π cm³" },
        { letra: "d", texto: "108\π cm³" },
        { letra: "e", texto: "144\π cm³" }
      ],
      resposta: "c",
      gabarito: {
        letra: "c",
        ancora: "A diagonal da seção meridiana do cilindro é o diâmetro da esfera: D = 2R = 10 cm. (2r)^2 + h^2 = 10^2 -> 4r^2 + 36 = 100 -> 4r^2 = 64 -> r^2 = 16. O volume é V = \π r^2 h = \π (16) (6) = 96\π cm³.",
    ...
    },
    {
      ...
      gabarito: {
        letra: "c",
        ancora: "Geratriz g = \√(8^2 + 6^2) = 10 cm. Área do triângulo meridiano A = (12 \· 8)/2 = 48 cm². Semiperímetro p = (10 + 10 + 12)/2 = 16 cm. O raio da circunferência inscrita é R = A / p = 48 / 16 = 3,0 cm.",
    ...
    },
    {
      ...
      gabarito: {
        letra: "b",
        ancora: "Sejam M e N os pontos médios de duas arestas reversas. A altura de cada face é h = a\√(3)/2. No triângulo isósceles formado pelos pontos médios e vértices: d^2 = (a\√(3)/2)^2 - (a/2)^2 = (3a^2/4) - (a^2/4) = 2a^2/4 \⇒ d = a\√(2)/2.",
...
salvar('Matematica/IME_ITA/Questoes_Numeros_Complexos_e_Polinomios_IME_ITA.json', {
  ...
  benchmark_didatico: {
    ...
    resumo_teorico: {
      conceitos_chave: [
        "Forma Algébrica e Módulo: z = a + bi (com i^2 = -1). Módulo |z| = \ρ = \√(a^2 + b^2). Conjugado \z* = a - bi. Propriedade fundamental: z \· \z* = |z|^2.",
        "Forma Trigonométrica e Fórmula de Euler: z = \ρ(cos\θ + i\sen\θ) = \ρ e^{i\θ}, onde \θ = arg(z) com \tg\θ = b/a e quadrante respeitado.",
        "Potenciação e Radiciação (De Moivre): z^n = \ρ^n [cos(n\θ) + i\sen(n\θ)] = \ρ^n e^{i n\θ}. Raízes n-ésimas: w_k = \√[n]{\ρ} \· e^{i(\θ + 2k\π)/n}, para k = 0, 1, ..., n-1 (vértices de um polígono regular de n lados centrado na origem).",
        ...
        "Teorema das Raízes Conjugadas: Se um número complexo z = \α + \β i (\β != 0) é raiz de um polinômio com coeficientes reais, o seu conjugado \z* = \α - \β i também é raiz com a mesma multiplicidade."
      ],
      atencao_ponto_cego: "Principais armadilhas em IME/ITA:\n1. Raízes n-ésimas da unidade (z^n = 1): a soma de todas as raízes n-ésimas da unidade é SEMPRE zero (\Σ_{k=0}^{n-1} w_k = 0), propriedade crucial para simplificar somatórios trigonométricos avançados.\n2. Polinômios com coeficientes NÃO reais: se os coeficientes do polinômio forem números complexos, o Teorema das Raízes Conjugadas NÃO é válido (o conjugado da raiz pode não ser raiz).\n3. Multiplicidade de raízes: se r é raiz dupla de P(x), então P(r) = 0 e P'(r) = 0 (a primeira derivada se anula no ponto r)."
    },
    exemplo_resolvido: {
      ...
      resolucao_passo_a_passo: [
        ...
        "3. Aplicação da terceira relação de Girard (produto das raízes): (r - d) \· r \· (r + d) = -(-48)/1 = 48.",
        "4. Substituindo r = 4: (4 - d) \· 4 \· (4 + d) = 48 -> (16 - d^2) \· 4 = 48 -> 16 - d^2 = 12 -> d^2 = 4 -> d = \± 2.",
  ...
  questoes: [
    ...
    },
    {
      ...
      gabarito: {
        letra: "b",
        ancora: "|z| = |3 + 4i| / |1 - i| = \√(3^2 + 4^2) / \√(1^2 + (-1)^2) = 5 / \√(2) = 5\√(2) / 2.",
    ...
    },
    {
      ...
      tipo: "fechada",
      enunciado: "O valor da expressão complexa Z = \((1 + i)^8)/((1 - i)^4) é igual a:",
      imagem_descricao: null,
      alternativas: [
        { letra: "a", texto: "-4" },
        { letra: "b", texto: "4" },
    ...
    },
    {
      ...
      gabarito: {
        letra: "a",
        ancora: "S_1 = r_1+r_2+r_3 = 6; S_2 = r_1 r_2 + r_1 r_3 + r_2 r_3 = 11. (r_1+r_2+r_3)^2 = r_1^2+r_2^2+r_3^2 + 2S_2 -> 6^2 = \Σ r_i^2 + 2(11) -> 36 - 22 = 14.",
    ...
    // BLOCO 2: CONSOLIDAÇÃO (6 a 10)
    {
      ...
      tipo: "fechada",
      enunciado: "Dado o número complexo z = \√(3) + i, o menor número inteiro positivo n para o qual z^n é um número real estritamente positivo é:",
      ...
      gabarito: {
        letra: "b",
        ancora: "|z| = 2; \θ = \π/6. z^n = 2^n e^{i n\π/6}. Para ser real positivo, n\π/6 = 2k\π \⇒ n = 12k. Menor inteiro positivo: n = 12.",
    ...
    },
    {
      ...
      gabarito: {
        letra: "c",
        ancora: "P(2) = 0 \⇒ 2(8) - 5(4) + 2k - 2 = 0 \⇒ 16 - 20 + 2k - 2 = 0 \⇒ 2k - 6 = 0 \⇒ k = 3.",
    ...
    },
    {
      ...
      tipo: "fechada",
      enunciado: "O argumento principal do número complexo z = -1 + i\√(3) pertence a qual quadrante e vale exatamente:",
      imagem_descricao: null,
      alternativas: [
      ...
      gabarito: {
        letra: "b",
        ancora: "a = -1 < 0 e b = \√(3) > 0 -> 2º quadrante. \tg\θ = -\√(3). No 2º quadrante, \θ = 180° - 60° = 120° (ou 2\π/3 rad).",
    ...
    },
    {
      ...
      gabarito: {
        letra: "b",
        ancora: "Raízes: r/q, r, rq. Produto das raízes por Girard: (r/q) \· r \· (rq) = -(-64)/1 = 64 \⇒ r^3 = 64 \⇒ r = 4.",
    ...
    // BLOCO 3: APROFUNDAMENTO & EXCELÊNCIA (11 a 15)
    {
      ...
      gabarito: {
        letra: "c",
        ancora: "|z - (3 + 4i)| = 2 representa uma circunferência centrada em z_0 = 3 + 4i com raio R = 2. A distância da origem ao centro é |z_0| = \√(3^2 + 4^2) = 5. Pela desigualdade triangular, o valor máximo de |z| é |z_0| + R = 5 + 2 = 7.",
    ...
    },
    {
      ...
      tipo: "fechada",
      enunciado: "Seja \ω = e^{i \(2\π)/(7)} uma raiz sétima da unidade diferente de 1. O valor da expressão S = \ω + \ω^2 + \ω^4 satisfaz uma equação do segundo grau de coeficientes inteiros da forma S^2 + S + k = 0. O valor da constante inteira k é igual a:",
      imagem_descricao: null,
      alternativas: [
        { letra: "a", texto: "1" },
        { letra: "b", texto: "2" },
      ...
      gabarito: {
        letra: "b",
        ancora: "Sejam S = \ω + \ω^2 + \ω^4 e T = \ω^3 + \ω^5 + \ω^6. Como 1 + \ω + ... + \ω^6 = 0, temos S + T = -1. Multiplicando: S \· T = (\ω + \ω^2 + \ω^4)(\ω^3 + \ω^5 + \ω^6) = \ω^4 + \ω^6 + \ω^7 + \ω^5 + \ω^7 + \ω^8 + \ω^7 + \ω^9 + \ω^{10} = 3 + (\ω + \ω^2 + \ω^3 + \ω^4 + \ω^5 + \ω^6) = 3 + (-1) = 2. Logo S satisfaz S^2 - (S+T)S + ST = 0 \⇒ S^2 - (-1)S + 2 = S^2 + S + 2 = 0, portanto k = 2.",
    ...
    },
    {
      ...
      gabarito: {
        letra: "a",
        ancora: "Como x_i é raiz: x_i^3 = 3x_i - 1. Somando para i = 1, 2, 3: \Σ x_i^3 = 3(\Σ x_i) - 3. Por Girard, a soma das raízes é -0/1 = 0. Logo \Σ x_i^3 = 3(0) - 3 = -3.",
